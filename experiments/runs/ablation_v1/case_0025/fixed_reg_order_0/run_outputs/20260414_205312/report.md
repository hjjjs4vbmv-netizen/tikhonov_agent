...
**Iter 0** | λ=1.415e-09 | RMSE=0.1029 | under_regularized | → switch_reg_order_to_1
  - Under-regularisation suspected: osc=0.23, L1_rough=144932.3800
  - Fit is good but regularisation balance is uncertain

**Iter 1** | λ=4.933e-09 | RMSE=0.1000 | under_regularized | → stop_success_weak_pass
