...
**Iter 0** | λ=7.579e-10 | RMSE=0.0993 | under_regularized | → increase_lambda
  - Under-regularisation suspected: osc=0.45, L1_rough=70997.9434
  - Fit is good but regularisation balance is uncertain

**Iter 1** | λ=3.789e-09 | RMSE=0.1100 | under_regularized | → increase_lambda
  - Under-regularisation suspected: osc=0.23, L1_rough=63002.0859
  - Fit is good but regularisation balance is uncertain

**Iter 2** | λ=1.895e-08 | RMSE=0.1295 | under_regularized | → stop_success_weak_pass
