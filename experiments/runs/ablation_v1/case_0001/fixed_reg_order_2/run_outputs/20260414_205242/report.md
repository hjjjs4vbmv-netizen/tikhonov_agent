...
**Iter 0** | λ=1.415e-09 | RMSE=0.1001 | under_regularized | → increase_lambda
  - Under-regularisation suspected: osc=0.36, L1_rough=66339.4039
  - Fit is good but regularisation balance is uncertain

**Iter 1** | λ=7.075e-09 | RMSE=0.1141 | under_regularized | → increase_lambda
  - Under-regularisation suspected: osc=0.23, L1_rough=63693.7515
  - Fit is good but regularisation balance is uncertain

**Iter 2** | λ=3.538e-08 | RMSE=0.1398 | under_regularized | → stop_success_weak_pass
