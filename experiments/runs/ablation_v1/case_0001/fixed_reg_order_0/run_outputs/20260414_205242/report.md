...
**Iter 0** | λ=7.579e-10 | RMSE=0.1000 | under_regularized | → switch_reg_order_to_1
  - Under-regularisation suspected: osc=0.68, L1_rough=113793.7751
  - Fit is good but regularisation balance is uncertain

**Iter 1** | λ=1.934e-09 | RMSE=0.1002 | under_regularized | → switch_reg_order_to_2
  - Under-regularisation suspected: osc=0.41, L1_rough=62774.1877
  - Fit is good but regularisation balance is uncertain

**Iter 2** | λ=1.415e-09 | RMSE=0.1001 | under_regularized | → increase_lambda
  - Under-regularisation suspected: osc=0.36, L1_rough=66339.4039
  - Fit is good but regularisation balance is uncertain

**Iter 3** | λ=7.075e-09 | RMSE=0.1141 | under_regularized | → increase_lambda
  - Under-regularisation suspected: osc=0.23, L1_rough=63693.7515
  - Fit is good but regularisation balance is uncertain

**Iter 4** | λ=3.538e-08 | RMSE=0.1398 | under_regularized | → stop_success_weak_pass
