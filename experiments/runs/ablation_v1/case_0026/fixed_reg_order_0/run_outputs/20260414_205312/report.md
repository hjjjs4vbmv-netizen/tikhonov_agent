...
**Iter 0** | λ=7.579e-10 | RMSE=0.1016 | under_regularized | → switch_reg_order_to_1
  - Under-regularisation suspected: osc=0.23, L1_rough=138666.9832
  - Fit is good but regularisation balance is uncertain

**Iter 1** | λ=2.642e-09 | RMSE=0.1008 | under_regularized | → stop_success_weak_pass
