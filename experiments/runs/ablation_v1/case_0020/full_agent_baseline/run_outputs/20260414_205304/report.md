...
**Iter 0** | λ=1.415e-09 | RMSE=0.1010 | under_regularized | → switch_reg_order_to_2
  - Under-regularisation suspected: osc=0.23, L1_rough=160438.9950
  - Fit is good but regularisation balance is uncertain

**Iter 1** | λ=1.036e-09 | RMSE=0.0992 | under_regularized | → increase_lambda
  - Under-regularisation suspected: osc=0.23, L1_rough=170501.1871
  - Fit is good but regularisation balance is uncertain

**Iter 2** | λ=5.178e-09 | RMSE=0.1236 | under_regularized | → increase_lambda
...
**Iter 3** | λ=2.589e-08 | RMSE=0.1676 | under_regularized | → increase_lambda
...
**Iter 4** | λ=1.294e-07 | RMSE=0.2075 | under_regularized | → stop_success_weak_pass
